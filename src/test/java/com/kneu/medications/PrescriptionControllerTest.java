...
public class PrescriptionControllerTest {
  ...
  void whenInputValidPrescriptionCreatedSuccessfully() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/prescription")
  ...
  void whenPrescriptionIsMissingMedicationIdValidationErrorReturned() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath("$.message")
                .value(PrescriptionValidationError.MISSING_MEDICATION_ID.getName()));
  }
  ...
  void whenPrescriptionIsLinkedToNonExistingMedicationIdErrorReturned() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath("$.message")
                .value(PrescriptionValidationError.MEDICATION_NOT_FOUND.getName()));
  }

  @Test
  void whenIntakeTimeIsMissingValidationErrorReturned() throws Exception {
    CreatePrescriptionRequest request =
        new CreatePrescriptionRequest(MEDICATION_ID.toString(), null, LABEL);
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.status").value(HttpStatus.BAD_REQUEST.value()))
        .andExpect(
            jsonPath("$.message").value(PrescriptionValidationError.MISSING_INTAKE_TIME.getName()));
  }

  @Test
  void whenIntakeTimeIsInvalidValidationErrorReturned() throws Exception {
    CreatePrescriptionRequest request =
        new CreatePrescriptionRequest(MEDICATION_ID.toString(), "10", LABEL);
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath("$.message")
                .value(PrescriptionValidationError.INVALID_INTAKE_TIME_FORMAT.getName()));
  }
